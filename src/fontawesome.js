...
import { faCheckSquare, faCoffee, faHome, faUser,faBell,faNetworkWired, faStar, faGear,faGears, faGlobe, faCalendar, faMessage, faPeopleArrows, faAngleDown,faAngleUp,faRssSquare, faEllipsis, faHeart, faComment, faShare, faLink, faPlus, faUserCheck, faUserGroup, faPersonChalkboard , faHandshake, faHandHoldingDollar, faUserGraduate, faCircleXmark, faBookmark, faPenToSquare } from '@fortawesome/free-solid-svg-icons'; // Import specific solid icons
